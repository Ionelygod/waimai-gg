<template>
  <div class="shop-header">
    ...
    <div class="shop-header-discounts" @click="isShowSupports=true" v-if="info.supports">
      <div class="discounts-left ellipsis" >
    ...
    <div class="activity-sheet" v-if="isShowSupports">
      <div class="activity-sheet-content">
        <h2 class="activity-sheet-title">
          优惠活动</h2>
        <ul class="list">
          <li class="activity-item" :class="colorClassArr[support.type]" v-for="(support, index) in info.supports" :key="index">
            <span class="content-tag">
  ...
  export default {
    data(){
      return {
        ...
        colorClassArr:['activity-green','activity-red','activity-orange']
      }
    },
    computed:{
      ...mapState({
